(() => {
  ...
  const apply = (frame) => {
    try {
      ...
      style.textContent = `
        .mts-draft-role .role-content-section{padding:0 0 clamp(5.5rem,9vw,9rem)!important}
        .mts-draft-role .role-content{max-width:1380px!important}
        ...
        @media(max-width:760px){
          ...
          .mts-draft-role .role-content-section{padding-bottom:4.5rem!important}
